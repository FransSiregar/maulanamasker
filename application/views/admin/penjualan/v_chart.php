		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid">
						...
						<div class="card-body">
							<form class="form-horizontal" method="post" action="<?php echo base_url('admin/Penjualan/chart'); ?>">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="date" class="form-control pullright" id="start_date" name="start_date">
											</div>
											<!-- /.input group -->
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label class="font-weightbold"> End Date </label>
											<div class="input-group">
												<div class="input-groupprepend">
													<span class="input-group-text"> <i class="fas fa-calendar-day"></i></span>
												</div>
												<input type="date" class="form-control pullright" id="end_date" name="end_date">
											</div>
										</div>
									</div>
									<div class="col-md-2">
					...
					<div class="card mb-4">
						<div class="card-header font-weight-bold"><i class="fas fa-chart-line mr1"> </i> Grafik Garis Penjualan
							<button class="btn btn-warning" onclick="LinePDF();" style="float: right;">
								<i class="fas fa-chart-line"></i> Export Chart
							</button>
							<a id="download" download="LineChartPenjualan.jpg">
								<button type="button" style="float: right; margin: 1px;" class="btn btn-warning" onClick="downloadLine()">
									<i class="fas fa-file-image"></i> Download
								</button>
							</a>
						</div>
						<div class="card-body">
							<canvas id="pnjLine" width="80%" height="30"></canvas>
						</div>
					...
					<div class="card mb-4">
						<div class="card-header font-weight-bold"><i class="fas fa-chart-bar"> </i> Grafik Batang Penjualan
							<button class="btn btn-warning" onclick="BarPDF();" style="float: right;">
								<i class="fas fa-chart-bar"></i> Export Chart
							</button>
							<a id="download1" download="BarChartPenjualan.jpg">
								<button type="button" style="float: right; margin: 1px;" class="btn btn-warning" onClick="downloadBar()">
									<i class="fas fa-file-image"></i> Download
								</button>
							</a>
						</div>
						<div class="cardbody"><canvas id="pnjBar" width="100%" height="30"></canvas></div>
						<div class="card-footer small text-muted"></div>
					</div>
					<!-- End Grafik Batang Penjualan -->
					<!-- Start Tabel Data Penjualan -->
					<div class="card mb-4">
						<div class="card-header font-weight-bold"><i class="fas fa-table mr1"> </i> Data Penjualan
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered tablehover" id="dataTable" width="100%" cellspacing="0">
									<thead style="text-align:center">
										<tr>
											<th width="10%">No.Nota</th>
											<th width="12%">Nama Kasir</th>
											<th width="12%">Pembeli</th>
											<th width="14%">Tgl Jual</th>
									...
									<tbody>
										...
										?>
											<tr style="text-align:center">
												...
												<?php
												if ($pelanggan_name == "") {
													$pelanggan_name = '== Pembeli Bukan Member ==';
												} else {
													$pelanggan_name;
												}
												?>
												...
												?>
												<td><?php echo number_format($amount); ?> Items </td>
